...
//			 echo"<br>$query";
		...
		?>
          ...
          <a href='del.php?x=<?php echo $row['product_code'];?>' style="text-decoration:none;"> <input type="button" name="view" value="delete" style="width:100px; height:25px; color:#FFFFFF; border:#FFFFFF 1px solid; background-color:#006699; border-radius:5px;"></a>
